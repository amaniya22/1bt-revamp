    ...
    <section class="page-header page-header-xs">
      <div class="container">
        ...
        <ol class="breadcrumb breadcrumb-inverse">
          ...
          <li class="active">Intern – Software Engineer (.NET)</li>
        </ol><!-- /breadcrumbs -->
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-sm-8">
            <div class="careers-left">
              <h1 class="blog-post-title">Intern – Software Engineer (.NET)</h1><!-- article content -->
<h2 class="margin-bottom-20">Qualifications</h2>
 ...
 <li><i class="fa fa-angle-double-right"></i>Candidates should possess a minimum current GPS of 2.8.</li>
 ...
 <li><i class="fa fa-angle-double-right"></i>Knowledge in .Net</li>
 <li><i class="fa fa-angle-double-right"></i>Knowledge in Azure would be an added advantage.</li>
