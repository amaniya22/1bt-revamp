...
<body class="smoothscroll enable-animation">
  ...
  <div id="wrapper">
    ...
    <section class="height-400" id="slider" style="background:url('assets/images/seo-bg.jpg')">
        ...
        <div class="display-table-cell vertical-align-middle padding-top-50">
          ...
          <div class="container">
            ...
            <div class="slider-featured-text ">
              ...
              <h1 class="text-white wow fadeInUp" data-wow-delay="0.4s">SOCIAL MEDIA, SEO

                <span class="text-yellow">& ANALYTICS</span>

              

              </h1>

              <h2 class="weight-300 text-white wow fadeInUp animated" data-wow-delay="1.2s" style="visibility: visible; animation-delay: 1.2s; animation-name: fadeInUp;">Connecting brands and people through social media interactions
    ...
    <!-- <section class="page-header page-header-xs">
      ...
      <div class="container">
        ...
        <ol class="breadcrumb breadcrumb-inverse">
          ...
          <li class="active">Social Media, SEO & Analytics
    ...
    <section id="#">
      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <img class="img-responsive" src="assets/images/img-17.jpg" alt="">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <header class="margin-bottom-10 section-title">
            ...
            <h1>Strong Audience Engagement</h1>

          </header>

          <p class="dropcap">Social media presence has become an extension of people connecting with people. Now more than ever, companies are challenged with being in the top search results and delivering exciting and engaging visual and text content, enabling this connection.<br><br>



                Our SEO process involves a deep understanding of your business, consumers and competition. Our social experts help you produce lasting organic SEO results, which result in repeat conversions and real sales.</p>
