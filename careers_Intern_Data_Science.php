    ...
    <section class="page-header page-header-xs">
      <div class="container">
        ...
        <ol class="breadcrumb breadcrumb-inverse">
          ...
          <li class="active">Intern – Data Science</li>
        </ol><!-- /breadcrumbs -->
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-sm-8">
            <div class="careers-left">
              <h1 class="blog-post-title">Intern – Data Science</h1><!-- article content -->
<h2 class="margin-bottom-20">Qualifications</h2>
              <div class="p-b-20">
                <ul class="list-unstyled list-icons">
                <li><i class="fa fa-angle-double-right"></i>Following a Bachelor's degree in IT/Software Engineering or Computer Science from a reputed university.</li>
  <li><i class="fa fa-angle-double-right"></i>Candidates should possess a minimum current GPA of 2.8.</li>
  <li><i class="fa fa-angle-double-right"></i>12 months full-time basis commitment (if required, should be able to continue after internship).</li>
  <li><i class="fa fa-angle-double-right"></i>Knowledge in Data Science.</li>
  <li><i class="fa fa-angle-double-right"></i>Knowledge in AWS would be an added advantage.</li>
  <li><i class="fa fa-angle-double-right"></i>Must have the ability to function as a team player with a positive attitude.</li>
  <li><i class="fa fa-angle-double-right"></i>The selected candidates will receive an allowance on par with industry standards and prospects for a career path within the organization.</li>
  <li><i class="fa fa-angle-double-right"></i>All candidates who are interested in a career in software engineering are welcome to apply.</li>
 </ul>
</div>
