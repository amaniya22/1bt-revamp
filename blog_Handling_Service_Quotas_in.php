      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-sm-8">
            ...
            <h1 class="blog-post-title">Handling Service Quotas in AWS</h1>
              <div>
...
<p><strong>Step 1</strong>: Log in to your AWS account and search for &ldquo;Service Quotas&rdquo;. You will see the following dashboard (see Figures 1 and 2).</p>
...
<li>Adjustable &mdash; Indicates if these limits could be adjusted or not. If it says YES, then you can click the Auto Scaling Feature to get to the next screen for adjustments (see Figures 6 and 7).</li>
</ol>
