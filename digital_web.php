...
<body class="smoothscroll enable-animation">
  ...
  <div id="wrapper">
    ...
    <section class="height-400" id="slider" style="background:url('assets/images/web-bg.jpg')">
        ...
        <div class="display-table-cell vertical-align-middle padding-top-50">
          ...
          <div class="container">
            ...
            <div class="slider-featured-text ">
              ...
              <h1 class="text-white wow fadeInUp" data-wow-delay="0.4s">WEBSITE DESIGN & CUSTOMER<br>

                <span class="text-yellow">JOURNEY MAPPING</span>

                <span class="text-yellow"> </span>

              </h1>

              <h2 class="weight-300 text-white wow fadeInUp animated" data-wow-delay="1.2s" style="visibility: visible; animation-delay: 1.2s; animation-name: fadeInUp;">A clever blend of web strategy, web design, content and technology
    ...
    <section class="page-header page-header-xs">
      ...
      <div class="container">
        ...
        <ol class="breadcrumb breadcrumb-inverse">
          ...
          <li class="active">Website Design & Customer Journey Mapping</li>
    ...
    <section id="#">
      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <img class="img-responsive" src="assets/images/img-11.jpg" alt="">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <header class="margin-bottom-10 section-title">
            ...
            <h1>Creating Websites of Distinction</h1>

          </header>

          <p class="dropcap">Websites, done right, become an explosive tool to foster revolutionary change in consumer connection. In today’s digital economy, having a great website is paramount and creates a foundation for a brand’s success.<br><br>



              Auxenta Digital focuses on creating a deeper connection between you and your consumer by designing solutions that take a consumer on a journey, keeping them excited and intently engaged.<br><br>

              

              Auxenta Digital provides a complete design and tech solution for clients across the globe. Leave it to us; we simplify the complicated for you.</p>
