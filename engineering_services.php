...
<body class="smoothscroll enable-animation">
  ...
  <div id="wrapper">
    ...
    <!-- SLIDER -->
    <section class="height-400" id="slider" style="background:url('assets/images/main-engineering.jpg')">
        ...
        <div class="display-table-cell vertical-align-middle padding-top-50">
          <div class="container">
            <div class="slider-featured-text ">
              <h1 class="text-white wow fadeInUp" data-wow-delay="0.4s">ENGINEERING
                <span class="text-yellow"> SERVICES </span>
              </h1>
              <h2 class="weight-300 text-white wow fadeInUp animated" data-wow-delay="1.2s" style="visibility: visible; animation-delay: 1.2s; animation-name: fadeInUp;">Cutting edge engineering practices targeting enterprises and independent software vendors
              </h2>
    ...
    <section>
      <div class="container">
        ...
        <header class="text-center margin-bottom-60 section-title">
          <h2>AUXENTA ENGINEERING SERVICES</h2>
        ...
        <div class="row padding-bottom-30">
          ...
          <div class="col-md-6">
            ...
            <div class="box-flip box-color box-icon box-icon-center box-icon-round box-icon-large text-center">
              <div class="front">
                <div class="box1" style="background-color:#09f; min-height: 610px;">
    ...
    <section class="callout-dark heading-title heading-arrow-top">
      <div class="container">
        ...
        <div class="text-center">
          <h3 class="size-40 weight-800">90-Day Minimum Viable Product Development Program</h3>
          <div class="size-30 padding-top-20">If you are looking to test new ideas quickly with minimum time and investment, our 90-day MVP program is made for
            you!
          </div>
          <a href="assets/pdf/MVP-program.pdf" rel="nofollow" target="_blank" class="btn btn-info btn-lg margin-top-30">LEARN MORE</a>
        </div>
        ...
        <div class="row padding-20">
          ...
          <div class="col-md-4">
            ...
            <div class="box-image text-center">
              <a href="case_study_bitcoin_bazaar.html">
          ...
          <div class="col-md-4">
            ...
            <div class="box-image text-center">
              ...
              <a class="box-image-title" href="case_study_millionspaces.html">
