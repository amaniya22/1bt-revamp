            ...
            <div class="careers-left">
              ...
              <div class="margin-bottom-80">
                ...
                <div class="padding-top-15">
                  ...
                  <p>The company was seeking to implement a cloud-based, multi-tenant client management platform for investment companies. After the initial Cloud migration assessment, which was completed by the 1 Billion Tech team, they came up with a more cost effective and more reliable Serverless Architecture for the proposed project. </p>
                </div>
                <div class="padding-top-15">
                  <h3>How 1 Billion Tech helped</h3><br>
                  <p>1 Billion Tech cloud architects along with the software development team were engaged in the completion of the following phases.<br>
