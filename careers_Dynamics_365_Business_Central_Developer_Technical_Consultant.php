        ...
        <div class="row">
          ...
          <div class="col-md-8 col-sm-8">
            <div class="careers-left">
              <h1 class="blog-post-title">Dynamics 365 Business Central Developer / Technical Consultant</h1><!-- article content -->
...
<li><i class="fa fa-angle-double-right"></i>Delivery of Development CRs: Execute full lifecycle: development, testing (incl. automated), documentation, and deployments across environments, work closely with QA and functional teams to validate the delivery, ensure timely and quality ticket closure.</li>
...
<h2 class="margin-bottom-20">Qualifications</h2>
 ...
 <li><i class="fa fa-angle-double-right"></i>3-5 Years previous experience. 
