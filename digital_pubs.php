...
<body class="smoothscroll enable-animation">
  ...
  <div id="wrapper">
    ...
    <section class="height-400" id="slider" style="background:url('assets/images/pub-bg-2.jpg')">
        ...
        <div class="display-table-cell vertical-align-middle padding-top-50">
          ...
          <div class="container">
            ...
            <div class="slider-featured-text ">
              ...
              <h1 class="text-white wow fadeInUp" data-wow-delay="0.4s">BRANDING &<br>

                <span class="text-yellow">VISUAL COMMUNICATIONS</span>

              

              </h1>

              <h2 class="weight-300 text-white wow fadeInUp animated" data-wow-delay="1.2s" style="visibility: visible; animation-delay: 1.2s; animation-name: fadeInUp;">Seamless brand communication through digital media
    ...
    <!-- <section class="page-header page-header-xs">
      ...
      <div class="container">
        ...
        <ol class="breadcrumb breadcrumb-inverse">
          ...
          <li class="active">Branding & Visual Communications</li>
    ...
    <section id="#">
      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <img class="img-responsive" src="assets/images/img-13.jpg" alt="">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <header class="margin-bottom-10 section-title">
            ...
            <h1>Digital Publishing for Marketing</h1>

          </header>

          <p class="dropcap">Building great branding content and visual communications has proven to be a powerful mode of creating strong brand identity.<br><br>



                We provide you with the expertise you need – whether it is for a new brand, rebranding or even refreshing your existing brand – by truly understanding what your brand is and what it stands for. By way of such a rigorous exercise, we provide you with modern and classy branding choices that resonate with your brand values. Needless to say, we love creating things people love.</p>
