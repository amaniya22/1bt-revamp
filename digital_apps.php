...
<body class="smoothscroll enable-animation">
  ...
  <div id="wrapper">
    ...
    <section class="height-400" id="slider" style="background:url('assets/images/app-bg.jpg')">
        ...
        <div class="display-table-cell vertical-align-middle padding-top-50">
          ...
          <div class="container">
            ...
            <div class="slider-featured-text ">
              ...
              <h1 class="text-white wow fadeInUp" data-wow-delay="0.4s">MOBILE & WEB APP <br>

                <span class="text-yellow"> INTERFACE DESIGN </span>

              </h1>

              <h2 class="weight-300 text-white wow fadeInUp animated" data-wow-delay="1.2s" style="visibility: visible; animation-delay: 1.2s; animation-name: fadeInUp;">User-centric Mobile & web app design
    ...
    <!-- <section class="page-header page-header-xs">
      ...
      <div class="container">
        ...
        <ol class="breadcrumb breadcrumb-inverse">
          ...
          <li class="active">Mobile & Web App Interface Design</li>
      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <header class="margin-bottom-10 section-title">
            ...
            <h1>World Class Design & Development</h1>

          </header>

          <p class="dropcap">Design is more than simply aesthetics. We engage with Clients to achieve a grander goal. Our job is to better understand your business and to ultimately tell a compelling story.

<br><br>

              Auxenta Digital uses powerful tools, coupled with the most trending design principles to create a beautifully crafted experience for your brand. Our expertise in UI and UX design goes beyond face value, as our design experts are fully invested in your success at every stage of the design process. Together, we craft messaging that moves consumers to action, ensuring your brand resonates with your values.</p>
