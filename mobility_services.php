...
<body class="smoothscroll enable-animation">
  ...
  <div id="wrapper">
    ...
    <!-- <section class="height-400" id="slider" style="background:url('assets/images/main-mobility.webp')">
      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <header class="margin-bottom-10 section-title">
            ...
            <h1>Mobile Device & Application Management (MDM / MAM)</h1>
          ...
          <ul class="list-unstyled list-icons">
            ...
            <li>
              ...
              <i class="fa fa-angle-double-right"></i>Enforce business policies</li>

            <li>

              <i class="fa fa-angle-double-right"></i>Monitor devices</li>

            <li>

              <i class="fa fa-angle-double-right"></i>Remote lock/wipe devices</li>

            <li>

              <i class="fa fa-angle-double-right"></i>App management</li>

            <li>

              <i class="fa fa-angle-double-right"></i>Administration, distribution, security, tracking, versions, management</li>
      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <header class="margin-bottom-10 section-title">
            ...
            <h1>Mobile Backend as a Service (MBaaS)</h1>
          ...
          <ul class="list-unstyled list-icons">
            ...
            <li>
              ...
              <i class="fa fa-angle-double-right"></i>Unified API gateway & API management</li>

            <li>

              <i class="fa fa-angle-double-right"></i>Services orchestration, data optimization & transformation</li>

            <li>

              <i class="fa fa-angle-double-right"></i>Enterprise authentication & security</li>

            <li>

              <i class="fa fa-angle-double-right"></i>Social media intergration</li>

            <li>

              <i class="fa fa-angle-double-right"></i>Distributed caching</li>

            <li>

              <i class="fa fa-angle-double-right"></i>Analytics, dashboard, auditing & reporting</li>

            <li>

              <i class="fa fa-angle-double-right"></i>Highly scalable environment (cloud | on premise)</li>
      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <header class="margin-bottom-10 section-title">
            ...
            <h1>Development Accelerators</h1>
          ...
          <ul class="list-unstyled list-icons">
            ...
            <li>
              ...
              <i class="fa fa-angle-double-right"></i>Reusable, native-cross platform supported libraries</li>

            <li>

              <i class="fa fa-angle-double-right"></i>Reusable, mobile-web supported set of libraries</li>

            <li>

              <i class="fa fa-angle-double-right"></i> Universal container & mobile unit test suite</li>

            <li>

              <i class="fa fa-angle-double-right"></i>Reusable mobile STARTER KITS & KITCHEN SINKS</li>
          ...
          <div class="col-md-4">
            ...
            <div class="box-image text-center">
              ...
              <a href="case_study_silVR.php">
                ...
                <img class="img-responsive" src="assets/images/silvr-casestudy.jpg" alt="">

              </a>



              <a class="box-image-title" href="case_study_silVR.php">

                <h2 class="tex-white">Trending VR implementation</h2>
